...
// @router   PUT  api/posts/un like/:id
// @desc     Unlike a post
// @access   Private
...
router.delete('/comment/:id/:comment_id', auth, async (req, res) => {
  try {
    ...
    const updateComments = post.comments.filter((comment) => {
    ...
    // Remove comment
    // const updateComments = post.comments.map((comment) => {
    //   comment.id !== req.params.comment_id;
    // });

    // post.comments.unshift(updateComments);
